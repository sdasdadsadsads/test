    ...
    <div class="content">
        ...
        <div class="container-fluid">
                            ...
                            <div class="card-body">
                                ...
                                <div class="col-12 col-md-12 col-lg-12">
                                    <div class="row">
                                        ...
                                        <input type="hidden" name="statusDataSearch" id="statusDataSearch" class="form-control" placeholder="">
            ...
            <ul class="nav nav-tabs nav-bordered">
                ...
                <li class="nav-item">
                    <a href="" id="waiting_transfer" data-bs-toggle="tab" aria-expanded="true" class="nav-link">
                        รอโอน
                    </a>
                </li>
                <li class="nav-item">
                    <a href="" id="successful_transfer" data-bs-toggle="tab" aria-expanded="true" class="nav-link">
                        โอนสำเร็จ
                    </a>
                </li>
                <li class="nav-item">
                    <a href="" id="cancel" data-bs-toggle="tab" aria-expanded="true" class="nav-link">
                        ยกเลิก
                    </a>
                </li>
                <li class="nav-item">
                    <a href="" id="delete" data-bs-toggle="tab" aria-expanded="true" class="nav-link">
                        ลบ
                    </a>
                </li>
                <li class="nav-item">
                    <a href="" id="problem" data-bs-toggle="tab" aria-expanded="true" class="nav-link">
                        ปัญหา
                    </a>
                </li>
                <li class="nav-item">
                    <a href="" id="pending_transaction" data-bs-toggle="tab" aria-expanded="true" class="nav-link">
                        รอทำรายการ
                    </a>
                </li>
                <li class="nav-item">
                    <a href="" id="Failed_transfer" data-bs-toggle="tab" aria-expanded="true" class="nav-link">
                        โอนไม่สำเร็จ
                    </a>
                </li>
                <!-- <li class="nav-item">
            ...
            <script>
                ...
                $("#withdraw_total").on('click', function update_withdraw() {
                    document.getElementById("statusDataSearch").value = "";
                    filter();
                });

                $("a#waiting_transfer").on('click', function() {
                   document.getElementById("statusDataSearch").value = 1;
                    filter();
                });

                $("a#successful_transfer").on('click', function() {
                    document.getElementById("statusDataSearch").value = 2;
                    filter();
                });

                $("a#cancel").on('click', function() {
                    document.getElementById("statusDataSearch").value = 3;
                    filter();
                });
                ...
                $("a#problem").on('click', function() {
                    document.getElementById("statusDataSearch").value = 4;
                    filter();
                });

                $("a#pending_transaction").on('click', function() {
                    document.getElementById("statusDataSearch").value = 6;
                    filter();
                });

                $("a#Failed_transfer").on('click', function() {
                    document.getElementById("statusDataSearch").value = 7;
                    filter();
                });
                                                        ...
                                                        $.ajax({
                                                            ...
                                                            if (re.status == true) {
                                                                if (re.data.status == 6) {
                                                                    ...
                                                                    $('#showrefreshR' + withdraw_id).html('<button type="button" class="btn btn-warning waves-effect waves-light" title="" onClick="reback_withdraw_modal(' + withdraw_id + ')" disabled ><i class="mdi mdi-refresh"></i> </button>');
                                                                    clearInterval(chek);
