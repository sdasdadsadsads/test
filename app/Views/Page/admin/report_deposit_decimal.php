    ...
    <div class="content">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        <h4 class="page-title">รายงานการสร้างฝากทศนิยม</h4>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <form id="form_deposit_decimal" method="post" action="<?= base_url('report_deposit_decimal/csv') ?>">
                            <?= csrf_field() ?>
                            <div class="card-body">
            ...
            <script>
                ...
                function filter() {
                    $("#loader").show();
                    $.ajax({
                            url: '<?php echo base_url('report_deposit_decimal/filter') ?>',
                            type: "POST",
